...
export const FriendProfileCard = ({ user, index, setFriendList }: Props) => {
  ...
  const onDeleteButtonClick = () => {
    const deleteFriend = async () => {
      try {
        ...
        setFriendList(prev => prev.splice(index, 1));
      } catch (e) {
      ...
      >
        <div className="flex justify-self-center items-center">
          {typeof user.profileImage === 'undefined' ? (
            ...
            <Avatar src={user.profileImage} alt="profileImage" size="md" />
          )}
