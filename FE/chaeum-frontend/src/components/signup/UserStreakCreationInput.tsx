...
const UserStreakCreationInput = ({
  ...
  const [studyMiddleCategoryList, setStudyMiddleCategroyList] = useState<string[]>([]);
  const [sportsMiddleCategoryList, setSportsMiddleCategroyList] = useState<string[]>([]);
  ...
  return (
    ...
    >
      <div className="flex flex-col w-10/12 h-full justify-center">
        ...
        <Dropdown mainCategory="공부" middleCategoryList={studyMiddleCategoryList}/>
        <Dropdown mainCategory="운동" middleCategoryList={sportsMiddleCategoryList}/>
        <TextBox
          height="h-16"
