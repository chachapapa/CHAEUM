...
export const MyProfileCard = ({
  ...
  return (
    <div className="z-50 grid grid-cols-[1fr_3fr_1fr] grid-rows-2 p-2 w-11/12 justify-self-center self-center rounded-md shadow-[0_0_5px_5px_rgba(208,211,222,0.5)] shadow-chauem-gray-500/50 ">
      ...
      <div className=" justify-self-center self-center ">
        <span className="font-bold  text-chaeum-gray-900">최장스트릭</span>
      </div>
