...
- git branch 는 git clone을 할 프로젝트의 branch를 선택하면 됨
...
- credentials에 SSH Username with private key를 선택
...
- 고급을 클릭해서 Secret token을 발급 받을 수 있음
    ...
    - URL에는 젠킨스에서 Build when a change~~ 에서 제일 옆에 보면 있는 URL을 넣어주면 됨
